...
class MerchantsConfig:
    ...
    share_external_unknown: float = 0.02  # cashout/unknown rails

    # Bank-visible payment intensity (NOT all 48/month; choose a subset)
    # Atlanta Fed diary: ~48 payments/month overall, ~38 purchases + ~10 bills. :contentReference[oaicite:3]{index=3}
